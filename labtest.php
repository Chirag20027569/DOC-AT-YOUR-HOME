...
<section class="appointment" id="appointment">
    ...
    <h1 class="heading"> <span>LAB</span> TESTS </h1>    
    ...
    <div class="row">
        ...
        <form action="labtest.php" method="post">
            ...
            <h3>MAKE LAB TESTS</h3>
            <?php include('errors.php'); ?>
            <input type="text"name="name" placeholder="your name" class="box">
            <input type="number"name="number" placeholder="your number" class="box">
            <input type="email"name="email" placeholder="your email" class="box">
            <input type="date"name="date" class="box">
            <select name="lab" value="lab" id="lab" class="box">
                <option value="selected">Select LAB TEST</option>
                <option value="Blood glucose test">Blood glucose testt</option>
            ...
            <input type="submit" name="labtest" value="BOOK LAB TEST" class="btn">
        </form>
