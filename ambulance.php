...
<section class="appointment" id="appointment">
    ...
    <h1 class="heading"> <span>Ambulance</span>Booking </h1>    
    ...
    <div class="row">
        ...
        <form action="ambulance.php" method="post">
            ...
            <select name="ambulancetype" value="ambulancetype" id="ambulancetype" class="box">
            ...
            <input type="submit" name="ambulance" value="BOOK AMBULANCE" class="btn">
        </form>
