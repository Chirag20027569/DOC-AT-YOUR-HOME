...
<section class="appointment" id="appointment">
    ...
    <h1 class="heading"> <span>Dental</span> Care </h1>    
    ...
    <div class="row">
        ...
        <form action="dental.php" method="post">
            ...
            <select name="dentaltype" value="dentaltype" id="dentaltype" class="box">
            ...
            <input type="submit" name="dental" value="appointment now" class="btn">
        </form>
